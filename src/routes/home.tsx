...
export const Route = createFileRoute("/home")({
  head: () => ({
    meta: [
      { title: "المکہ فیکٹری — Al-Makkah Factory" },
      ...
      <footer className="border-t border-primary/10 py-10">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-urdu text-sm text-primary">المکہ فیکٹری</div>
              <div className="text-[10px] uppercase tracking-widest text-muted-foreground">Al-Makkah Factory · Ziyad Khan</div>
            </div>
          </div>
